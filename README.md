...
A cli to browse and watch anime (alone AND with friends). This tool scrapes the site [nepu](www.nepu.to)
...
To install mpv (and vlc) you need *RPM Fusion free* enabled. Simply follow the instructions here: <https://rpmfusion.org/Configuration>
